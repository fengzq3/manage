    ...
    window.customDialog = {
        ...
        setDialog: function (obj, id, successCallBack) {
            ...
            if (confirmContent === '' || typeof confirmContent === 'undefined') {
                //显示占位
                dialog.find('.modal-body').html('<div class=\"noDate\"><img src=\"/expo/expo/center/img/listload.gif\" /><p>数据载入中...</p></div>');
                //获取并设置内容
                $.ajax({
                    url: action,
                    type: 'get',
            ...
            function setDialogError(e) {
                dialog.find('.modal-body').html('<div class=\"noDate\"><img src=\"/expo/expo/center/img/error.png\" /><p>数据载入错误，请重试！</p></div>');
                if(!!successCallBack){
        ...
        setSlidePanel: function (obj, id, callBack) {
            ...
            //设置占位内容
            slidePanel.find('.panel-body').html('<div class=\"noDate\"><img src=\"/expo/expo/center/img/listload.gif\" /><p>数据载入中...</p></div>');
            //显示slidePanel
            slidePanelBg.show();
            ...
            function setSlideFail(data) {
                slidePanel.find('.panel-body').html('<div class=\"noDate\"><img src=\"/expo/expo/center/img/error.png\" /><p>数据载入失败，请重试！</p></div>');
                if (typeof callBack === 'function') {
